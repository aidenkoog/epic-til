...
## PG, VAN, PG+VAN 개념
    - 결제 시스템에서 흔히 언급되는 VAN사(Value-Added Network)와 PG사(Payment Gateway)는 전자 결제의 중심적인 역할을 맡는 중계 업체들입니다. 이 둘은 비슷해 보이지만, 역할과 기술적 위치가 다릅니다. 아래에서 개념, 역할, 차이점, 겸업사례, 그리고 결제 흐름 전체 구조까지 체계적으로 정리해드릴게요.
...
개념
	•	VAN은 **오프라인 카드 결제(단말기 기반)**를 위한 네트워크 제공자입니다.
...
2. PG사 (Payment Gateway, 결제 대행사)

개념
	•	PG사는 온라인 결제를 위한 전자 결제 인프라 제공 업체입니다.
	•	온라인 쇼핑몰에서 카드사나 간편결제사 등과의 연결을 중계해주는 회사입니다.
...
일부 회사는 VAN과 PG 양쪽 모두 사업을 수행합니다.
...
참고: PG사는 카드사 수수료 + PG 중개 수수료를 합쳐 가맹점에 청구합니다.
