...
6. 산업제어시스템(ICS, Industrial Control System) 보안의 개념과 주요 위협 요소
개념
...
중앙 모니터링 시스템 구축(SIEM)
디지털 서명된 펌웨어 사용
7. IoT 보안에서 Secure Boot와 Trusted Execution Environment(TEE)의 개념
Secure Boot
...
- AI 기반 사이버 보안 기술(AI-Driven Cybersecurity)의 개념과 주요 활용 사례를 설명하시오.
  - 1. IoT 환경에서 보안 위협 탐지(Security Monitoring)의 개념과 주요 기술
개념
...
2. 자동차 보안(Vehicle Security)의 개념과 주요 취약점 (ECU Hacking, CAN Bus Attack 등)
개념
...
3. 의료 IoT 보안(Medical IoT Security)의 개념과 주요 보안 위협
개념
...
4. AI 보안(AI Security)의 개념과 기존 보안과의 차이
AI 보안 개념
...
5. AI 기반 사이버 보안 기술(AI-Driven Cybersecurity)의 개념과 주요 활용 사례
개념
...
2. AI 기반 이상 탐지(Anomaly Detection)의 개념과 주요 적용 사례
개념
...
클라우드 API 호출 이상 탐지
3. 딥페이크(Deepfake)의 개념과 보안 위협 및 대응 방안
개념
...
AI 기반 포렌식 기술 고도화
4. AI 기반 피싱 공격(Phishing Attack with AI)의 개념과 방어 기법
개념
...
보안 이메일 게이트웨이(SEG) 연계
사용자 교육 + 이메일 서명 확인 강화
5. AI 모델의 신뢰성 및 설명 가능성(XAI, Explainable AI)의 개념과 필요성
개념
...
모델 내 주의 메커니즘 활용
6. AI 윤리(AI Ethics)와 AI 사용 시 발생할 수 있는 보안 문제
AI 윤리 개념
...
5. 모바일 운영체제(Android, iOS)의 보안 아키텍처 차이
Android
...
6. 모바일 기기의 데이터 보호를 위한 주요 암호화 기법
파일 기반 암호화 (FBE)
...
- 모바일 멀웨어(Mobile Malware) 유형과 주요 탐지 및 대응 방법을 설명하시오.
  - 1. 엔드포인트 보안(Endpoint Security)의 개념과 주요 구성 요소
개념
...
암호화 및 접근 제어
행위 기반 위협 탐지
2. EPP(Endpoint Protection Platform)와 EDR(Endpoint Detection and Response)의 차이
EPP (사전 예방 중심)
...
3. 모바일 기기에서 원격 접근(RDP, VNC, SSH 등) 시 보안 위협과 대응 방법
주요 위협
...
4. BYOD(Bring Your Own Device) 환경에서의 보안 위험과 대응 방안
위험 요인
...
강제 암호화 및 인증 정책 적용
기기紛실 시 원격 초기화(Remote Wipe) 기능 활성화
5. 모바일 환경에서 2FA(Two-Factor Authentication)와 MFA(Multi-Factor Authentication)의 개념과 차이
2FA
...
6. 모바일 멀웨어(Mobile Malware) 유형과 주요 탐지 및 대응 방법
주요 유형
...
- 폴리모픽(Polymorphic) 및 메타모픽(Metamorphic) 악성코드의 개념과 주요 차이를 설명하시오.
  - 1. 랜섬웨어(Ransomware)의 개념과 주요 감염 경로
개념
...
3. 안티바이러스(Anti-Virus)와 EDR(Endpoint Detection and Response)의 개념과 차이
안티바이러스
...
4. 스파이웨어(Spyware)와 애드웨어(Adware)의 개념과 주요 차이
Spyware
...
5. 파일리스(Fileless) 공격의 개념과 주요 대응 방안
개념
...
로그 및 이벤트 분석 강화
6. 폴리모픽(Polymorphic) 및 메타모픽(Metamorphic) 악성코드의 개념과 주요 차이
Polymorphic Malware
...
- 소프트웨어 보안 개발 수명주기(Secure SDLC)의 개념과 주요 단계(요구사항, 설계, 개발, 테스트, 배포)를 설명하시오.
  - 1. C2(Command & Control) 서버 기반 공격의 개념과 탐지 방법
개념
...
2. 악성코드 분석 기법(정적 분석, 동적 분석, 행위 분석)의 개념과 차이
정적 분석
...
행위: 전반적 탐지 정확성 향상
3. 파일 무결성 검증(Hashing, Checksum, Digital Signature)을 활용한 악성코드 탐지 방법
Hashing
