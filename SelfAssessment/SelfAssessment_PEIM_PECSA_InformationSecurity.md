...
보안 정책(Security Policy)의 개념과 주요 유형

1. 보안 정책(Security Policy) 개념

✅ 보안 정책(Security Policy) 은 조직의 정보 자산을 보호하기 위해 보안 목표, 원칙, 지침을 정의한 문서로, 정보 보호를 위한 기준과 절차를 명확하게 규정하는 역할을 한다.
...
보안 정책은 목적과 적용 범위에 따라 규범적(정책적), 운영적(관리적), 기술적(기술적 통제) 3가지로 구분된다.

(1) 규범적 보안 정책 (Normative Security Policy)
...
(2) 운영적 보안 정책 (Operational Security Policy)
...
(3) 기술적 보안 정책 (Technical Security Policy)
...
구분	설명	주요 내용	대상
규범적 보안 정책	보안 목표 및 원칙 수립	정보보호 정책, 개인정보 보호 정책	조직 전체
운영적 보안 정책	보안 운영을 위한 관리적 절차 정의	접근 제어, 비밀번호 정책, 보안 교육	관리자, 직원
기술적 보안 정책	보안 기술 적용 기준 정의	암호화, 방화벽 설정, 네트워크 보안	IT 관리자, 보안 엔지니어

✅ 한 조직에서는 위 3가지 보안 정책을 모두 수립하고 운영해야 함

4. 보안 정책 수립 시 고려해야 할 사항
	1.	법적 규제 및 표준 준수
...
5. 정리
	...
	•	주요 유형
	1.	규범적 보안 정책 → 조직 전체 보안 목표 및 원칙 정의 (최상위 정책)
	2.	운영적 보안 정책 → 보안 운영을 위한 절차 및 관리적 조치 (비밀번호, 접근 제어, 교육)
	3.	기술적 보안 정책 → 방화벽, 암호화, 네트워크 보안 등 기술적 조치
