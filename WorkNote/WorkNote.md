...
- 면접관 경험, 면접관 입장에서의 태도, 자세, 질문 의도, 질문 리스트, 정답/오답/개인의견
- 늘 비슷한 방식으로 업무 및 기술 적용하는 관습 타개 방법, 주변 개발자들과의 이야기 및 의욕 고취 또는 내가 주변사람에게 좋은 영향을 주는 방법
- 매니저와 개발자 또는 피엠 중 어느쪽이 더 잘맞는가 성격적으로 업무 기술적으로 잘할수 있는 분야는 어디인가
- 다양한 시스템 아키텍쳐 이해하는 훈련 필요, 그리고 문제의 핵심 및 논의 아젠다 프리젠테이션 훈련 필요
